...
"[project]/app/api/save-zip/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const maxSavedZips = user.subscriptionPlan === "monthly" ? 5 : user.subscriptionPlan === "yearly" ? 15 : 0;
        ...
        const blobResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vercel$2f$blob$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["put"])(`saved-zips/${session.user.id}/${zipName}.zip`, buffer, {
            access: "public",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a9b2c17c._.js.map